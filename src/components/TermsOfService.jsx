...
export default function TermsOfService() {
  return (
    <>
      <Helmet>
        <title>Terms of Service - De Vibe Agency</title>
        <meta name="description" content="Read De Vibe's Terms of Service outlining the rules and regulations for using our website." />
      </Helmet>
      <section className="bg-alt" style={{ minHeight: '80vh', padding: '6rem 0' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '3rem', fontWeight: 700, textAlign: 'center' }}>Terms of Service</h1>
