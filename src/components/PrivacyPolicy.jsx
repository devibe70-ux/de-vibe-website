...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - De Vibe Agency</title>
        <meta name="description" content="Read De Vibe's privacy policy to understand how we collect, protect, and use your personal information." />
      </Helmet>
      <section className="bg-alt" style={{ minHeight: '80vh', padding: '6rem 0' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '3rem', fontWeight: 700, textAlign: 'center' }}>Privacy Policy</h1>
